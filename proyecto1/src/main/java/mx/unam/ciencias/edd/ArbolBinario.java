...
public abstract class ArbolBinario<T> implements Coleccion<T> {
    ...
    protected class Vertice implements VerticeArbolBinario<T> {
        ...
        public VerticeArbolBinario<T> padre() {
            if (padre == null)
                throw new NoSuchElementException("Este vertice no tiene padre.");
            return padre;
        }
        ...
        public VerticeArbolBinario<T> izquierdo() {
            if (izquierdo == null)
                throw new NoSuchElementException("Este vertice no tiene hijo izquierdo.");
            return izquierdo;
        }
        ...
        public VerticeArbolBinario<T> derecho() {
            if (derecho == null)
                throw new NoSuchElementException("Este vertice no tiene hijo derecho.");
            return derecho;
        }
        ...
        private boolean equals(Vertice verticeA, Vertice verticeB) {
            if (verticeA == verticeB)
                return true;
            if (verticeA == null || verticeB == null)
                return false;
            if (!verticeA.elemento.equals(verticeB.elemento))
                return false;
            return equals(verticeA.izquierdo, verticeB.izquierdo) && equals(verticeA.derecho, verticeB.derecho);
        }
    ...
    private VerticeArbolBinario<T> busca(Vertice vertice, T elemento) {
        ...
        VerticeArbolBinario<T> aux = busca(vertice.izquierdo, elemento);
        if (aux != null) {
            return aux;
        }
    ...
    public String toString() {
        if (raiz == null)
            return "";
        boolean[] a = new boolean[this.altura() + 1];
    ...
    private String toString(Vertice vertice, int nivel, boolean[] a) {
